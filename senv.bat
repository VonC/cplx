...
doskey irc="%project_dir%/src/install/install.bat" --reconfigure $*
...
doskey sdpl=cmd /V /C "set CPLX_FORCE_RELOAD_PACKAGES=1 && "%project_dir%/src/setups/setup.bat" packages "download_packages_list" $*"
